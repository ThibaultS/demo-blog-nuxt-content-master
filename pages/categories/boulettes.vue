      ...
      <b-container fluid="lg" class="animate animate3 slideUp">
        <b-row>
          <b-col class="intro mt-5 mb-3">
            <h1>Voilà de la boulette !</h1>
            <p class="lead">
              Franchement les boulettes c'est vraiment le feu ! Ça vous permet
              d'assaisonner votre viande avec les épices et les herbes de votre
              choix. Retrouvez sur cette page toutes mes recettes de boulettes
              avec du boeuf, de l'agneau, du poulet,... Pour découvrir mes
              dernières recettes je vous invite à me suivre sur
              <a
      ...
      meta: [
        {
          ...
          name: 'description',
          content:
            'Découvrez toutes mes recettes avec des boulettes faites maison : poulet, boeuf, agneau,...'
        },
        {
          hid: 'og:image',
          name: 'og:image',
