      ...
      <b-container fluid="lg" class="animate animate3 slideUp">
        <b-row>
          <b-col class="intro mt-5 mb-3">
            <h1>Mes recettes de soupes et veloutés</h1>
            <p class="lead">
              En hiver comme en été, une soupe est toujours agréable. Je vous en
              propose pour tous les goûts. Des soupes chaudes pour l'hiver, des
              veloutés froids pour l'été. Légères ou gourmandes et même quelques
              recettes sucrées. Pour découvrir mes nouvelles recettes, je vous
...
export default {
  async asyncData({ $content, params }) {
    const articles = await $content('articles', params.slug)
      ...
      .sortBy('id', 'desc')
      .limit(50)
      .where({ theme: 'Soupes et veloutés' })
      .fetch()
    return {
      articles
    }
  ...
  data() {
    return {
      title: 'Mes recettes de soupes et veloutés'
    }
  },
  head() {
    return {
      ...
      meta: [
        {
          ...
          name: 'description',
          content:
            'Toutes mes recettes de soupes et de veloutés pour tous les goûts : chaud, froid, salé, sucré...'
        },
        {
          hid: 'og:image',
          name: 'og:image',
