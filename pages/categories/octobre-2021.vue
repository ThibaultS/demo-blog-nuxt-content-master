      ...
      <b-container fluid="lg" class="animate animate3 slideUp">
        <b-row>
          <b-col class="intro mt-5 mb-3">
            <h1>Ma sélection de recettes pour le mois d'octobre 2021</h1>
            <p class="lead">
              Je vous ai concocté une sélection de 10 de mes recettes pour le
              mois d'octobre avec des fruits et légumes de saison : de la
              betterave, de la courge butternut, du potimarron, du potiron, de
              la carotte (tous les légumes oranges en gros) de la pomme, de la
              poire, des épinards, des myrtilles, des haricots verts, et plein
              de bonnes choses... En somme, je vous propose des plats
              réconfortants pour l'arrivée des mauvais jours. Pour découvrir mes
