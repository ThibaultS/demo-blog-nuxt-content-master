      ...
      <b-container fluid="lg" class="animate animate3 slideUp">
        <b-row>
          <b-col class="intro mt-5 mb-3">
            <h1>Mes recettes de poissons</h1>
            <p class="lead">
              Retrouvez sur cette page des recettes de poissons pour tous les
              goûts : saumon, thon, bar , cabillaud,... Pour découvrir mes
...
export default {
  ...
  data() {
    return {
      title: 'Mes recettes de poissons'
    }
  },
  head() {
    return {
      ...
      meta: [
        {
          ...
          name: 'description',
          content:
            'Mes recettes à base de poissons : saumon, thon, cabillaud, daurade, lotte,...'
        },
        {
          hid: 'og:image',
          name: 'og:image',
