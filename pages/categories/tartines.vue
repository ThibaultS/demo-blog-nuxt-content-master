      ...
      <b-container fluid="lg" class="animate animate3 slideUp">
        <b-row>
          <b-col class="intro mt-5 mb-3">
            <h1>Mes recettes de tartines</h1>
            <p class="lead">
              Il existe des milliers de tartines et de sauce à tartiner aux
              goûts de chacun. Pour découvrir mes nouvelles recettes je vous
...
export default {
  ...
  data() {
    return {
      title: 'Mes recettes de tartines'
    }
  },
  mounted() {
    this.showAd()
      ...
      meta: [
        {
          ...
          name: 'description',
          content:
            'Toutes mes recettes de tartines et sauces à tartiner pour tous les goûts.'
        },
        {
          hid: 'og:image',
          name: 'og:image',
